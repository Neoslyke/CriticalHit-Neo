...
public class Plugin : TerrariaPlugin
{
    ...
    private readonly string path = Path.Combine(TShock.SavePath, "CriticalHit.json");

    public override string Name => "CriticalHit";

    public override string Author => "Neoslyke, White, Stone·Free, 肝帝熙恩";

        public override Version Version => new Version(2, 1, 0);

    public override string Description => "Provides floating text effects when attacking NPCs";
